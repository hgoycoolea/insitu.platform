...
{
    public static class CategoriasClientesLogic
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        public static CategoriasClientes Get(int id)
        {
        ...
        /// <returns></returns>
        public static int Create(CategoriasClientes Broker)
        {
            using (MsSqlFacade<CategoriasClientes, CategoriasClientesMapper> facade = new MsSqlFacade<CategoriasClientes, CategoriasClientesMapper>())
            {
                //// we use the Collection to build the broker entity on an abstract phase to manage it as a all
        ...
        /// </summary>
        /// <returns></returns>
        public static List<CategoriasClientes> Read()
        {
            using (MsSqlFacade<CategoriasClientes, CategoriasClientesMapper> facade = new MsSqlFacade<CategoriasClientes, CategoriasClientesMapper>())
            {
                //// we use the Collection to build the broker entity on an abstract phase to manage it as a all
        ...
        /// <param name="Broker"></param>
        /// <returns></returns>
        public static int Update(CategoriasClientes Broker)
        {
            using (MsSqlFacade<CategoriasClientes, CategoriasClientesMapper> facade = new MsSqlFacade<CategoriasClientes, CategoriasClientesMapper>())
            {
                //// we use the Collection to build the broker entity on an abstract phase to manage it as a all
