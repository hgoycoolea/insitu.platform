...
{
    public class buyPromocion : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(ClientLogics.ComprarPromocion(int.Parse(id_promocion),int.Parse(id_cliente)));
                /// context response
