...
{
    public class ReadClientCategories : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(SatelliteLogics.ReadClientCategories(int.Parse(id_client)));
                /// context response
