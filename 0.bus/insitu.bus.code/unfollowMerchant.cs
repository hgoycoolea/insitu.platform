...
{
    public class unfollowMerchant : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(MerchantLogics.UnFollowMercante(int.Parse(id_mercante),int.Parse(id_cliente)));
                /// context response
