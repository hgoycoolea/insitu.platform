...
{
    public class getCiudadPorID : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(SatelliteLogics.getCiudadPorID(int.Parse(id_ciudad)));
                /// context response
