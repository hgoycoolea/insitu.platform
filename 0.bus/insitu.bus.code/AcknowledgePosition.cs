...
{
    public class AcknowledgePosition : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json =  JsonConvert.SerializeObject(SatelliteLogics.AcknowledgePosition(dynamic_obj.axis, int.Parse(dynamic_obj.mercante)));
                /// context response
