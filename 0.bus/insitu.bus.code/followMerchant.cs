...
{
    public class followMerchant : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(MerchantLogics.FollowMercante(int.Parse(id_mercante),int.Parse(id_cliente)));
                /// context response
