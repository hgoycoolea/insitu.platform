...
{
    public class getNumeroSeguidoresPorMercante : IHttpHandler
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                /// json
                string json = JsonConvert.SerializeObject(MerchantLogics.GetNumeroSeguidoresPorMercante(int.Parse(id)));
                /// context response
